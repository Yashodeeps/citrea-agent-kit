...
const ERC20_TEST_TOKEN_ADDRESS = '0xfe17C6aa5C3d8828c98e9c0BE46CeB81Aad95E14';
...
// Test CITREA balance
await test('get CITREA balance', async () => {
  const balance = await agent.getCITREABalance();
  console.log('CITREA Balance:', balance);
});
